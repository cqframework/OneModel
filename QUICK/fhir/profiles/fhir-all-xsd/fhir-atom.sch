...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="/a:feed/a:entry/a:content/f:Profile/f:structure/f:snapshot/f:element">
    ...
    <sch:rule context="/a:feed/a:entry/a:content/f:Profile/f:structure/f:snapshot/f:element/f:definition">
    ...
    <sch:rule context="/a:feed/a:entry/a:content/f:Profile/f:structure/f:snapshot/f:element/f:definition/f:max">
    ...
    <sch:rule context="/a:feed/a:entry/a:content/f:Profile/f:structure/f:snapshot/f:element/f:definition/f:type">
    ...
    <sch:rule context="/a:feed/a:entry/a:content/f:Profile/f:structure/f:snapshot/f:element/f:definition/f:binding">
    ...
    <sch:rule context="/a:feed/a:entry/a:content/f:Profile/f:structure/f:snapshot/f:element/f:definition/f:binding/f:referenceUri">
      <sch:assert test="starts-with(@value, 'http:') or starts-with(@value, 'https:')">Inv-13: uri SHALL start with http:// or https://</sch:assert>
    </sch:rule>
    <sch:rule context="/a:feed/a:entry/a:content/f:Profile/f:structure/f:snapshot/f:element/f:definition/f:binding/f:referenceResource">
      <sch:assert test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::a:content/f:*/f:contained/f:*[@id=substring-after(current()/f:reference/@value, '#')]|/f:*/f:contained/f:*[@id=substring-after(current()/f:reference/@value, '#')])">Inv-1: SHALL have a local reference if the resource is provided inline</sch:assert>
    </sch:rule>
    <sch:rule context="/a:feed/a:entry/a:content/f:Profile/f:extensionDefn">
  ...
  <sch:pattern>
    ...
    <sch:rule context="/a:feed/a:entry/a:content/f:OperationDefinition/f:parameter/f:type">
      <sch:assert test="not (exists(f:valueSet) and exists(f:code)) or exists(f:system)">Inv-1: If a valueSet is provided, a system URI Is required</sch:assert>
    </sch:rule>
    <sch:rule context="/a:feed/a:entry/a:content/f:OperationDefinition/f:parameter/f:type/f:valueSet">
      <sch:assert test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::a:content/f:*/f:contained/f:*[@id=substring-after(current()/f:reference/@value, '#')]|/f:*/f:contained/f:*[@id=substring-after(current()/f:reference/@value, '#')])">Inv-1: SHALL have a local reference if the resource is provided inline</sch:assert>
    </sch:rule>
  ...
  <sch:pattern>
    ...
    <sch:rule context="/a:feed/a:entry/a:content/f:ReferralRequest/f:subject">
      <sch:assert test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::a:content/f:*/f:contained/f:*[@id=substring-after(current()/f:reference/@value, '#')]|/f:*/f:contained/f:*[@id=substring-after(current()/f:reference/@value, '#')])">Inv-1: SHALL have a local reference if the resource is provided inline</sch:assert>
    </sch:rule>
